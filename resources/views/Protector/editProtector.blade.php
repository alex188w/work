...
<body>
            ...
            <div class="modal-content bg-body ">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Закрыть"
                        onclick="window.location='{{ route('showProtector', ['id' => $protector_id]) }}'"></button>
                </div>

                <form id="updateForm"
                    action="{{ route('updateProtector', ['protector_id' => $protector_id, 'work_id' => $work->id]) }}"
                    ...
                    <div class="modal-body">
                        <div class="id_name">
                            <div class="token col-sm-2 pb-2">
                                <label style="padding-top: 5px;" class="form-label">id протектора</label>
                                <input type="number" id="protector_id" value="{{ $work->protector_id }}" placeholder=""
                                    name="protector_id" class="form-control form-control-default" required=""
                            ...
                            <div class="token col-sm-3 pb-2">
                                ...
                                <input type="text" name="protector_name" id="protector_name" value="{{ $protectorName }}"
                        ...
                        <div class="parametr">
                            <div class="form-data">
                                ...
                                {{-- <label style="padding-top: 5px;" class="form-label">до покл. протектора</label> --}}
                                <input type="double" id="protector_id3" value="{{ $work->Utr_z }}" placeholder=""
                                    name="Utr_z" class="form-control form-control-default" autocomplete="off"
                                    data-mask="phone-1" data-init-mask="true">
                            </div>
                            <div class="form-data">
                                <label style="padding-top: 5px;" class="form-label">Uпр-з</label>
                                <input type="double" id="protector_id4" value="{{ $work->Upr_z }}" placeholder=""
                                    name='Upr_z' class="form-control form-control-default" autocomplete="off"
                                    data-mask="phone-1" data-init-mask="true">
                            </div>
                            <div class="form-data">
                                <label style="padding-top: 5px;" class="form-label">Uпол</label>
                                <input type="double" id="protector_id8" value="{{ $work->Upol }}" placeholder=""
                                    name="Upol" class="form-control form-control-default" autocomplete="off"
                                    data-mask="phone-1" data-init-mask="true">
                            </div>
                            <div class="form-data">
                                <label style="padding-top: 5px;" class="form-label">Iпр</label>
                                <input type="double" id="protector_id7" value="{{ $work->Ipr }}" placeholder=""
                                    name="Ipr" class="form-control form-control-default" autocomplete="off"
                                    data-mask="phone-1" data-init-mask="true">
                            </div>
                            <div class="form-data">
                                <label style="padding-top: 5px;" class="form-label">Rтр-пр</label>
                                <input type="double" id="protector_id8" value="{{ $work->Rpr_tr }}" placeholder=""
                                    name="Rpr_tr" class="form-control form-control-default" autocomplete="off"
                                    data-mask="phone-1" data-init-mask="true">
                            </div>
                            <div class="form-data">
                                <label style="padding-top: 5px;" class="form-label">&#961<sub>гр</sub></label>
                                <input type="double" id="protector_id8" value="{{ $work->Ro_grunt }}" placeholder=""
                                    name="Ro_grunt" class="form-control form-control-default" autocomplete="off"
                                    data-mask="phone-1" data-init-mask="true">
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal"
                            onclick="window.location='{{ route('showProtector', ['id' => $protector_id]) }}'">Закрыть</button>
                        <div class="submit-save">
                ...
                <form id="uploadForm" onsubmit="return false;"
                    action="{{ route('work.upload', ['ustanovka_id' => $protector_id, 'work_id' => $work->id]) }}"
                    enctype="multipart/form-data" method="POST">
                    @csrf
                    ...
                    <div class="photo">
                        <div class="photo-add">
                            ...
                            <div class="drop-area" id="drop-area">
                                ...
                                {{-- Скрытые поля для protector_id и work_id --}}
                                <input type="hidden" id="protector_id" name="protector_id"
                                    value="{{ $protector_id }}">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function(event) {
            ...
            const protectorId = document.getElementById("protector_id").value;
            ...
            uploadButton.addEventListener('click', () => {
                ...
                fetch(`/upload/${protectorId}/${workId}`, {
                        method: 'POST',
                        body: formData,
                        headers: {
    ...
    {{-- Скрипт для слайд-шоу галереи фотографий --}}
