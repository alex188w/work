...
<body>
    <div class="modal fade show" id="popup442073" tabindex="-1" aria-labelledby="popupLabel442073" remove-close="true"
        ...
        <div class="modal-dialog modal-lg modal-center">
            <div class="modal-content bg-add">
                ...
                <form action="{{ route('addProtectorPost', ['protector_id' => $protector_id]) }}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body" style="max-height:75vh; overflow:auto; overflow-x:hidden;">
                        <div class="id_name">
                            <div class="token col-sm-2 pb-2">
                                ...
                                <input type="number" id="protector_id" value="{{ $protector_id }}" placeholder=""
                            ...
                            <div class="token col-sm-3 pb-2">
                                ...
                                <input type="text" id="protector_name" value="{{ $protectorName }}" placeholder=""
    ...
    <script>
        $(document).ready(function() {
            $('#protector_id').on('input', function() {
                let id = $(this).val();
                if (id) {
                    $.ajax({
                        url: `{{ url('/get-protector-name') }}/${id}`,
                        type: 'GET',
                        success: function(response) {
                            $('#protector_name').val(response.name);
                        }
                    });
                } else {
                    $('#protector_name').val('');
    ...
    <script>
        ...
        const input = document.querySelector('#protector_name1');
