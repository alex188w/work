...
<body>
            ...
            <div class="modal-content bg-body ">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Закрыть"
                        onclick="window.location='{{ route('showAeroLine', ['id' => $aeroLine_id]) }}'"></button>
                </div>

                <form id="updateForm"
                    action="{{ route('updateAeroLine', ['aeroLine_id' => $aeroLine_id, 'work_id' => $work->id]) }}"
                    enctype="multipart/form-data" method="POST">
                    @csrf

                    <div class="modal-body">
                        <div class="id_name-aeroLine">                            
                            <div class="token col-sm-12 pb-2">
                                <label style="padding-top: 5px;" class="form-label">Наименование</label>
                                <input type="text" name="aeroLine_name" id="aeroLine_name"
                                    value="{{ $aeroLineName }}" placeholder=""
                        ...
                        <div class="id_name-aeroLine">
                            <div class="token col-sm-2 pb-2">
                                ...
                                <input type="number" id="aeroLine_id" value="{{ $work->aeroLine_id }}" placeholder=""
                                    name="aeroLine_id" class="form-control form-control-default" required=""
                        ...
                        {{-- <div class="parametr">
                            <div class="form-data">
                                ...
                                <input type="double" id="aeroLine_id3" value="{{ $work->Imax }}" placeholder=""
                            ...
                            <div class="form-data">
                                ...
                                <input type="double" id="aeroLine_id4" value="{{ $work->Imin }}" placeholder=""
                                    name="Imin" class="form-control form-control-default" autocomplete="off"
                                    data-mask="phone-1" data-init-mask="true">
                            </div>
                            <div class="form-data">
                                <label style="padding-top: 5px;" class="form-label">Iср</label>
                                <input type="double" id="aeroLine_id7" value="{{ $work->Icp }}" placeholder=""
                            ...
                            <div class="form-data">
                                ...
                                <input type="double" id="aeroLine_id8" value="{{ $work->Utr_z }}" placeholder=""
                            ...
                            <div class="form-data">
                                ...
                                <input type="double" id="aeroLine_id8" value="{{ $work->Utr_r }}" placeholder=""
                            ...
                            <div class="form-data">
                                ...
                                <input type="double" id="aeroLine_id8" value="{{ $work->Upol }}" placeholder=""
                        ...
                        <div class="work">
                            <div class="worker">
                                ...
                                <div class="token col-sm-4 pb-1">
                                    <label style="padding-top: 5px;" class="form-label">Выявленные
                                        замечания</label>
                        ...
                        <div class="journal">
                            <div class="journal-check">
                                ...
                                <div class="view-journal">
                                    ...
                                    <div class="submit-save">
                                        <p class="journal-title">Журнал осмотров и ППР ВЛ</p>
                                        <input type="checkbox" class="done-checkbox" value="1">
                                    </div>     
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal"
                            onclick="window.location='{{ route('showAeroLine', ['id' => $aeroLine_id]) }}'">Закрыть</button>
                        <div class="submit-save">
                ...
                <form id="uploadForm" onsubmit="return false;"
                    action="{{ route('work.upload', ['ustanovka_id' => $aeroLine_id, 'work_id' => $work->id]) }}"
                    enctype="multipart/form-data" method="POST">
                    @csrf
                    ...
                    <div class="photo">
                        <div class="photo-add">
                            ...
                            <div class="drop-area" id="drop-area">
                                ...
                                {{-- Скрытые поля для aeroLine_id и work_id --}}
                                <input type="hidden" id="aeroLine_id" name="aeroLine_id"
                                    value="{{ $aeroLine_id }}">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function(event) {
            ...
            const aeroLineId = document.getElementById("aeroLine_id").value;
            ...
            uploadButton.addEventListener('click', () => {
                ...
                fetch(`/upload/${aeroLineId}/${workId}`, {
                        method: 'POST',
                        body: formData,
                        headers: {
